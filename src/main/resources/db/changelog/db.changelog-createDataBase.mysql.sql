...
CREATE TABLE posts (id INT AUTO_INCREMENT NOT NULL, is_active BIT(1) NOT NULL, moderation_status ENUM('DECLINED', 'ACCEPTED', 'NEW') NOT NULL, moderator_id INT NULL, text LONGTEXT NOT NULL, time datetime NOT NULL, title VARCHAR(255) NOT NULL, view_count INT NOT NULL, user_id INT NOT NULL, CONSTRAINT PK_POSTS PRIMARY KEY (id));
